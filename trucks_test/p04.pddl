...
(preference c1 (always (or (time-now t0) (time-now t5) (time-now t1) (time-now t3) (time-now t2) (time-now t4) (at-destination package2 l2))))
(preference c2 (always (or (time-now t0) (time-now t5) (at-destination package5 l2) (time-now t1) (time-now t3) (time-now t2) (time-now t4))))
(preference c3 (always (or (time-now t0) (time-now t5) (time-now t1) (time-now t3) (at-destination package1 l2) (time-now t2) (time-now t4))))
)
)
(:metric minimize
(+
