...
(preference c1 (always (or  (time-now t0) (time-now t1) (time-now t3) (time-now t2) (time-now t4))))
(preference c2 (always (or (time-now t0) (time-now t1) (at-destination package3 l3) (time-now t3) (time-now t2) (time-now t4))))
)
)
(:metric minimize
(+
