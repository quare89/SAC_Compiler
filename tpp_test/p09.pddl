...
(preference c5 (always (or (loaded goods4 truck2 level0) (stored goods4 level0) (at truck2 depot1))))
(preference c6 (always (loaded goods4 truck1 level0)))
(preference c7 (always (or (loaded goods5 truck1 level0) (stored goods5 level0) (at truck1 depot1))))
(preference c8 (always (loaded goods5 truck2 level0)))
(preference c9 (always (or (loaded goods8 truck1 level0) (stored goods8 level0) (at truck1 depot1))))
(preference c10 (always (loaded goods8 truck2 level0)))
)
)
(:metric minimize
(+
(* 1 (is-violated p1A))(* 1 (is-violated c10))
(* 1 (is-violated c4))
(* 1 (is-violated c6))
(* 1 (is-violated c8))
(* 1 (is-violated c7))
