...
(preference c4 (always (or (loaded goods7 truck2 level0) (stored goods7 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c5 (always (loaded goods7 truck3 level0)))
(preference c6 (always (loaded goods7 truck1 level0)))
(preference c7 (always (or (loaded goods1 truck3 level0) (stored goods1 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c8 (always (loaded goods1 truck2 level0)))
(preference c9 (always (loaded goods1 truck1 level0)))
(preference c10 (always (or (loaded goods6 truck1 level0) (stored goods6 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c11 (always (loaded goods6 truck3 level0)))
(preference c12 (always (loaded goods6 truck2 level0)))
...
(preference c16 (always (or (loaded goods9 truck3 level0) (stored goods9 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c17 (always (loaded goods9 truck2 level0)))
(preference c18 (always (loaded goods9 truck1 level0)))
)
)
(:metric minimize
(+
