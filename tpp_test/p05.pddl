...
(preference c1 (always (or (loaded goods1 truck2 level0) (stored goods1 level0) (at truck2 depot1))))
(preference c2 (always (loaded goods1 truck1 level0)))
(preference c3 (always (or (loaded goods2 truck1 level0) (stored goods2 level0) (at truck1 depot1))))
(preference c4 (always (loaded goods2 truck2 level0)))
(preference c5 (always (or (loaded goods5 truck1 level0) (stored goods5 level0) (at truck1 depot1))))
(preference c6 (always (loaded goods5 truck2 level0)))
)
)
(:metric minimize
(+
