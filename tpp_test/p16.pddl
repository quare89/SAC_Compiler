...
(preference c7 (always (or (loaded goods7 truck1 level0) (stored goods7 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c8 (always (loaded goods7 truck2 level0)))
(preference c9 (always (loaded goods7 truck3 level0)))
(preference c10 (always (or (loaded goods9 truck1 level0) (stored goods9 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c11 (always (loaded goods9 truck2 level0)))
(preference c12 (always (loaded goods9 truck3 level0)))
...
(preference c16 (always (or (loaded goods10 truck2 level0) (stored goods10 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c17 (always (loaded goods10 truck1 level0)))
(preference c18 (always (loaded goods10 truck3 level0)))
(preference c19 (always (or (loaded goods16 truck2 level0) (stored goods16 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c20 (always (loaded goods16 truck1 level0)))
(preference c21 (always (loaded goods16 truck3 level0)))
(preference c22 (always (or (loaded goods14 truck3 level0) (stored goods14 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c23 (always (loaded goods14 truck2 level0)))
(preference c24 (always (loaded goods14 truck1 level0)))
)
)
(:metric minimize
(+
