...
(preference c3 (always (or (loaded goods3 truck2 level0) (stored goods3 level0) (at truck2 depot1))))
(preference c4 (always (loaded goods3 truck1 level0)))
)
)
(:metric minimize
(+ (* 1 (is-violated c3)) (* 1 (is-violated c2)) (* 1 (is-violated c1)) (* 1 (is-violated c4))
)
)
)
