...
(preference c1 (always (or (loaded goods3 truck1 level0) (stored goods3 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c2 (always (loaded goods3 truck2 level0)))
(preference c3 (always (loaded goods3 truck3 level0)))
...
(preference c7 (always (or (loaded goods6 truck1 level0) (stored goods6 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c8 (always (loaded goods6 truck3 level0)))
(preference c9 (always (loaded goods6 truck2 level0)))
(preference c10 (always (or (loaded goods7 truck1 level0) (stored goods7 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c11 (always (loaded goods7 truck2 level0)))
(preference c12 (always (loaded goods7 truck3 level0)))
(preference c13 (always (or (loaded goods9 truck3 level0) (stored goods9 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c14 (always (loaded goods9 truck2 level0)))
(preference c15 (always (loaded goods9 truck1 level0)))
(preference c16 (always (or (loaded goods11 truck3 level0) (stored goods11 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c17 (always (loaded goods11 truck2 level0)))
(preference c18 (always (loaded goods11 truck1 level0)))
(preference c19 (always (or (loaded goods13 truck3 level0) (stored goods13 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c20 (always (loaded goods13 truck2 level0)))
(preference c21 (always (loaded goods13 truck1 level0)))
(preference c22 (always (or (loaded goods16 truck3 level0) (stored goods16 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c23 (always (loaded goods16 truck1 level0)))
(preference c24 (always (loaded goods16 truck2 level0)))
(preference c25 (always (or (loaded goods18 truck2 level0) (stored goods18 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c26 (always (loaded goods18 truck1 level0)))
(preference c27 (always (loaded goods18 truck3 level0)))
(preference c28 (always (or (loaded goods19 truck2 level0) (stored goods19 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c29 (always (loaded goods19 truck3 level0)))
(preference c30 (always (loaded goods19 truck1 level0)))
)
)
(:metric minimize
(+
(* 1 (is-violated p1A))(* 1 (is-violated c28))
(* 1 (is-violated c8))
(* 1 (is-violated c4))
(* 1 (is-violated c6))
(* 1 (is-violated c7))
