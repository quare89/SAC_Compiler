...
(preference c4 (always (or (loaded goods2 truck1 level0) (stored goods2 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c5 (always (loaded goods2 truck3 level0)))
(preference c6 (always (loaded goods2 truck2 level0)))
(preference c7 (always (or (loaded goods4 truck3 level0) (stored goods4 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c8 (always (loaded goods4 truck1 level0)))
(preference c9 (always (loaded goods4 truck2 level0)))
...
(preference c13 (always (or (loaded goods7 truck2 level0) (stored goods7 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c14 (always (loaded goods7 truck3 level0)))
(preference c15 (always (loaded goods7 truck1 level0)))
(preference c16 (always (or (loaded goods11 truck2 level0) (stored goods11 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c17 (always (loaded goods11 truck3 level0)))
(preference c18 (always (loaded goods11 truck1 level0)))
(preference c19 (always (or (loaded goods12 truck2 level0) (stored goods12 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c20 (always (loaded goods12 truck3 level0)))
(preference c21 (always (loaded goods12 truck1 level0)))
(preference c22 (always (or (loaded goods13 truck1 level0) (stored goods13 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c23 (always (loaded goods13 truck2 level0)))
(preference c24 (always (loaded goods13 truck3 level0)))
(preference c25 (always (or (loaded goods18 truck3 level0) (stored goods18 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c26 (always (loaded goods18 truck1 level0)))
(preference c27 (always (loaded goods18 truck2 level0)))
)
)
(:metric minimize
(+
