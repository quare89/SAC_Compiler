...
(preference c1 (always (or (loaded goods2 truck2 level0) (stored goods2 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c2 (always (loaded goods2 truck3 level0)))
(preference c3 (always (loaded goods2 truck1 level0)))
...
(preference c10 (always (or (loaded goods5 truck3 level0) (stored goods5 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c11 (always (loaded goods5 truck1 level0)))
(preference c12 (always (loaded goods5 truck2 level0)))
(preference c13 (always (or (loaded goods11 truck3 level0) (stored goods11 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c14 (always (loaded goods11 truck2 level0)))
(preference c15 (always (loaded goods11 truck1 level0)))
)
)
(:metric minimize
(+
