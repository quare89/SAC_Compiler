...
(preference c1 (always (or (loaded goods2 truck1 level0) (stored goods2 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c2 (always (loaded goods2 truck3 level0)))
(preference c3 (always (loaded goods2 truck2 level0)))
(preference c4 (always (or (loaded goods3 truck1 level0) (stored goods3 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c5 (always (loaded goods3 truck2 level0)))
(preference c6 (always (loaded goods3 truck3 level0)))
...
(preference c10 (always (or (loaded goods7 truck2 level0) (stored goods7 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c11 (always (loaded goods7 truck3 level0)))
(preference c12 (always (loaded goods7 truck1 level0)))
(preference c13 (always (or (loaded goods8 truck2 level0) (stored goods8 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c14 (always (loaded goods8 truck3 level0)))
(preference c15 (always (loaded goods8 truck1 level0)))
(preference c16 (always (or (loaded goods9 truck1 level0) (stored goods9 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c17 (always (loaded goods9 truck2 level0)))
(preference c18 (always (loaded goods9 truck3 level0)))
(preference c19 (always (or (loaded goods10 truck1 level0) (stored goods10 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c20 (always (loaded goods10 truck3 level0)))
(preference c21 (always (loaded goods10 truck2 level0)))
)
)
(:metric minimize
(+
