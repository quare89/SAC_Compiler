...
(preference c1 (always (or (loaded goods3 truck3 level0) (stored goods3 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c2 (always (loaded goods3 truck1 level0)))
(preference c3 (always (loaded goods3 truck2 level0)))
(preference c4 (always (or (loaded goods2 truck2 level0) (stored goods2 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c5 (always (loaded goods2 truck3 level0)))
(preference c6 (always (loaded goods2 truck1 level0)))
(preference c7 (always (or (loaded goods1 truck2 level0) (stored goods1 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c8 (always (loaded goods1 truck3 level0)))
(preference c9 (always (loaded goods1 truck1 level0)))
(preference c10 (always (or (loaded goods8 truck3 level0) (stored goods8 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c11 (always (loaded goods8 truck2 level0)))
(preference c12 (always (loaded goods8 truck1 level0)))
(preference c13 (always (or (loaded goods14 truck2 level0) (stored goods14 level0) (at truck2 depot1) (at truck2 depot2))))
(preference c14 (always (loaded goods14 truck3 level0)))
(preference c15 (always (loaded goods14 truck1 level0)))
(preference c16 (always (or (loaded goods16 truck1 level0) (stored goods16 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c17 (always (loaded goods16 truck3 level0)))
(preference c18 (always (loaded goods16 truck2 level0)))
(preference c19 (always (or (loaded goods12 truck3 level0) (stored goods12 level0) (at truck3 depot1) (at truck3 depot2))))
(preference c20 (always (loaded goods12 truck2 level0)))
(preference c21 (always (loaded goods12 truck1 level0)))
(preference c22 (always (or (loaded goods5 truck1 level0) (stored goods5 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c23 (always (loaded goods5 truck2 level0)))
(preference c24 (always (loaded goods5 truck3 level0)))
(preference c25 (always (or (loaded goods17 truck1 level0) (stored goods17 level0) (at truck1 depot1) (at truck1 depot2))))
(preference c26 (always (loaded goods17 truck2 level0)))
(preference c27 (always (loaded goods17 truck3 level0)))
)
)
(:metric minimize
(+
(* 1 (is-violated p1A))(* 1 (is-violated c8))
(* 1 (is-violated c4))
(* 1 (is-violated c6))
(* 1 (is-violated c7))
(* 1 (is-violated c26))
